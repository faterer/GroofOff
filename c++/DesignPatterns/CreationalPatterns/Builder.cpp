...
public:
	...
	virtual void buildToppoing() { m_pizza->setTopping("ham+pineapple"); }
...
public:
	...
	virtual void buildToppoing() { m_pizza->setTopping("peperoni+salami"); }
