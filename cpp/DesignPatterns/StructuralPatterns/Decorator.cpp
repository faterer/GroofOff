// Decorator
// The decorator pattern helps to attach additional behavior or responsibilities to 
// an object dynamically. Decorators provide a flexible alternative to subclassing for 
...
int main() {
	...
	std::unique_ptr<Interface> messenger4 = 
					std::make_unique<MessengerWithValediction> (std::make_unique<MessengerWithSalutation>
